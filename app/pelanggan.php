...
class pelanggan extends Koneksi {
    ...
    public function simpan()
    {
        ...
        $pelanggan_obat_id = $_POST['pelanggan_obat_id'];
        $pelanggan_nama = $_POST['pelanggan_nama'];
        $pelanggan_nomorhp = $_POST['pelanggan_nomorhp'];
        $pelanggan_alamat = $_POST['pelanggan_alamat'];


        $sql = "INSERT INTO tb_pelanggan (pelanggan_obat_id, pelanggan_nama, pelanggan_nomorhp, pelanggan_alamat)
        VALUES (:pelanggan_obat_id, :pelanggan_nama, :pelanggan_nomorhp, :pelanggan_alamat)";
        $stmt = $this->db->prepare($sql);
        $stmt->bindParam(":pelanggan_obat_id", $pelanggan_obat_id);
    ...
    public function update()
    {
        ...
        $sql = "UPDATE tb_pelanggan SET pelanggan_obat_id=:pelanggan_obat_id, pelanggan_nama=:pelanggan_nama,
        pelanggan_nomorhp=:pelanggan_nomorhp, pelanggan_alamat=:pelanggan_alamat
