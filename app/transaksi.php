...
class transaksi extends koneksi {
    ...
    public function simpan()
    {
        ...
        $sql = "INSERT INTO tb_transaksi (transaksi_pelanggan_id, transaksi_tanggal, transaksi_id)
        VALUES (:transaksi_pelanggan_id, :transaksi_tanggal, :transaksi_id)";
        $stmt = $this->db->prepare($sql);
    ...
    public function update()
    {
        ...
        $sql = "UPDATE tb_transaksi SET transaksi_pelanggan_id=:transaksi_pelanggan_id,
        transaksi_tanggal=:transaksi_tanggal WHERE transaksi_id=:transaksi_id";
        $stmt = $this->db->prepare($sql);
        $stmt->bindParam(":transaksi_pelanggan_id", $transaksi_pelanggan_id);
        $stmt->bindParam(":transaksi_tanggal", $transaksi_tanggal);
        $stmt->bindParam(":transaksi_id", $transaksi_id);
